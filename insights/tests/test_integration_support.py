...
from insights.plugins.combiner_rule_with_filterable_parser_not_filtered import combiner_with_no_filtered_filterable_parser
...
def test_run_test_combiner_wo_filterable_parser():
    ...
    """
    input_data = InputData("fake_input")
    input_data.add(Specs.rhsm_conf, "FAKE_CONTENT")
...
def test_run_test_combiner_with_no_filtered_filterable_parser():
    ...
    with pytest.raises(Exception) as ex:
        run_test(combiner_with_no_filtered_filterable_parser, input_data, None)
